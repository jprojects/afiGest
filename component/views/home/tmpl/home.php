  ...
  <div class="container">
    <div class="form-outer text-center d-flex align-items-center">
      <div class="form-inner w-100">
        <div class="logo text-uppercase px-5"><img src="assets/img/logo2.png" height="25%" class="img-fluid" alt="<?= $config->sitename; ?>" style="width:65%"></div>
        ...
        <!-- <small>Imatge diària gràcies a Bing</small> -->
      </div>
    </div>
  </div>
</div>
