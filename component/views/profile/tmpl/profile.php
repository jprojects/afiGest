            ...
            <div class="row">
              ...
              <div class="col-md-6 col-md-4">
                <div class="form-group mb-4">
                  ...
                  <input type="text" placeholder="Codi Postal" value="<?= $user->cp; ?>" name="cp" class="form-control">
                </div>
              </div>
              <div class="col-md-6 col-md-4">
                <div class="form-group mb-4">
                  <label class="form-label">Població</label>
                  <input type="text" placeholder="Població" value="<?= $user->poblacio; ?>" name="poblacio" class="form-control">
                </div>
              </div>
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="form-group mb-0">
                  ...
                  <option value="en-gb" <?= $user->language == 'en-gb' ? 'selected' : ''; ?>><?= $lang->get('CW_SETTINGS_ENGLISH'); ?></option>
                  <option value="es-es" <?= $user->language == 'es-es' ? 'selected' : ''; ?>><?= $lang->get('CW_SETTINGS_SPANISH'); ?></option>
                  <option value="ca-es" <?= $user->language == 'ca-es' ? 'selected' : ''; ?>><?= $lang->get('CW_SETTINGS_CATALAN'); ?></option>
                  </select>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group mb-0">
                  ...
                  <option value="">Select an option</option>
                  <option value="green" <?= $user->template == 'green' ? 'selected' : ''; ?>>Green</option>
                  <option value="blue" <?= $user->template == 'blue' ? 'selected' : ''; ?>>Blue</option>
                  <option value="pink" <?= $user->template == 'pink' ? 'selected' : ''; ?>>Pink</option>
                  <option value="sea" <?= $user->template == 'sea' ? 'selected' : ''; ?>>Sea</option>
                  <option value="violet" <?= $user->template == 'violet' ? 'selected' : ''; ?>>Violet</option>
                  <option value="red" <?= $user->template == 'red' ? 'selected' : ''; ?>>Red</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-6 col-md-4">
                <div class="form-group mb-4">
                  ...
                  <input type="text" placeholder="TRC10 Wallet" value="<?= $user->wallet; ?>" name="wallet" class="form-control">
                </div>
              </div>
            </div>
          </div>
